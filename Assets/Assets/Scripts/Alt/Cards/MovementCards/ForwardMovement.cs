...
public class ForwardMovement : MovementCard
{
    ...
    public void OnMouseDown()
    {
        ...
        if (gameManagerInstance.canMove)
        {
            ...
            gameManagerInstance.movePlayer(gameManagerInstance.map[(int)gameManagerInstance.users[gameManagerInstance.playerIndex].currentGridPosition.x][(int)gameManagerInstance.users[gameManagerInstance.playerIndex].currentGridPosition.y - 1]);
        }
